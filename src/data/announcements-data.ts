...
// Centralized announcement data source for both AnnouncementPage and AnnouncementSidebar
 ...
 * Add new announcements here and they will automatically appear in both components
 */
...
/**
 * Helper function to get all active announcements
 */
export const getActiveAnnouncements = (): Announcement[] => {
  return ANNOUNCEMENTS.filter(
    (announcement) => announcement.is_active !== false,
  );
};

/**
 * Helper function to get announcements sorted by date (newest first)
 */
export const getSortedAnnouncements = (): Announcement[] => {
  return getActiveAnnouncements().sort(
    (a, b) => new Date(b.date).getTime() - new Date(a.date).getTime(),
  );
};

/**
 * Helper function to get recent announcements (limit to N items)
 */
export const getRecentAnnouncements = (limit: number = 10): Announcement[] => {
...
export const getAnnouncementsByPriority = (
  ...
  return getActiveAnnouncements().filter((a) => a.priority === priority);
};

/**
 * Helper function to get announcements by category
 */
export const getAnnouncementsByCategory = (
  category: string,
): Announcement[] => {
  return getActiveAnnouncements().filter((a) => a.category === category);
};

/**
 * Helper function to get today's announcements
 */
export const getTodaysAnnouncements = (): Announcement[] => {
