...
},
{
  ...
  tags: ["NEET PG 2025", "Gujarat Counselling", "Medical Admissions", "State Counselling"],
  published_date: "2025-10-25",
  read_time: 8,
  meta_description: "Complete guide to Gujarat NEET PG 2025 counselling including eligibility, seat types, reservation policies, fees, and registration process for postgraduate medical admissions.",
  sections: [
    {
      id: "intro",
      type: "paragraph",
      content: "Gujarat NEET PG 2025 counselling is now open, and this guide provides everything you need to know — including eligibility, seat types, reservation policies, fees, and essential documents. If you're planning to participate, read carefully to avoid mistakes. A thorough understanding of these guidelines is critical to a successful NEET PG counselling application."
    },
    {
      id: "why-wait",
      type: "heading",
      title: "Why Wait Before Registering?",
      level: 2
    },
    {
      id: "why-wait-content",
      type: "paragraph",
      content: "Although registration is open, there's no benefit to rushing. You'll have seven to eight days to register, so waiting until the second or third day is a smart choice. Early registration does not guarantee a better seat, as allotments are based solely on your NEET PG rank or state merit list."
    },
    {
      id: "registration-process",
      type: "heading",
    ...
    {
      id: "candidate-registration-content",
      type: "paragraph",
      content: "Log in with your User ID and PIN, complete personal details, category selection, and academic details. Upload a recent photograph and set a password for your account."
    },
    {
      id: "eligibility-checks",
      type: "heading",
      title: "3. Eligibility Checks",
      level: 3
    },
    {
      id: "eligibility-checks-content",
      type: "paragraph",
      content: "The system automatically verifies eligibility for the Government, Management, or NRI quota through your academic credentials and domicile status. Candidates with foreign MBBS degrees must upload FMGE clearance."
    },
    {
      id: "document-upload",
      type: "heading",
    ...
    },
    {
      ...
      items: [
        ...
        "Internship completion certificate (before 31st July 2025)",
        ...
        "NRI documents such as notarized passport copies and embassy certificates"
      ]
    },
    {
    ...
    {
      id: "appointment-booking-content",
      type: "paragraph",
      content: "Book a verification slot at a preferred center. NRI candidates must visit GMERS Gandhinagar for verification."
    },
    {
      id: "final-review",
      type: "heading",
      title: "6. Final Review and Submission",
      level: 3
    },
    {
      id: "final-review-content",
      type: "paragraph",
      content: "Review your application thoroughly before confirmation — once submitted, edits are not allowed. Save and print the final application form to use during NEET PG allotment and admission."
    },
    {
      id: "key-facts",
      type: "heading",
      title: "Key Facts About Gujarat NEET PG Counselling",
      level: 2
    },
    {
      id: "single-unified",
      type: "heading",
      title: "Single Unified Process",
      level: 3
    },
    {
      id: "single-unified-content",
      type: "paragraph",
      content: "Gujarat NEET PG counselling conducts a single round for:"
    },
    {
      id: "unified-list",
      type: "list",
      items: [
        "50% Government Quota seats (after AIQ surrender)",
        "100% Private College seats across Gujarat",
        "Deemed universities like SBKS (Sumandeep Vidyapeeth) fall under MCC NEET PG counselling instead."
      ]
    },
    {
      id: "not-open-state",
      type: "heading",
      title: "Not an Open State",
      level: 3
    },
    {
      id: "not-open-state-content",
      type: "paragraph",
      content: "Gujarat is not an open state for PG counselling. Only candidates with a Gujarat domicile or education history can apply for Gujarat medical PG counselling seats (except NRI quota)."
    },
    {
      id: "seat-categories",
      type: "heading",
      title: "Seat Categories in Gujarat NEET PG 2025",
      level: 2
    },
    {
      id: "seat-categories-table",
      type: "table",
      headers: ["Seat Type", "Description", "Eligibility"],
      rows: [
        ["GQ – Gujarat Quota", "75% of seats in government & private colleges", "All Gujarat-eligible candidates"],
        ["UQ – University Quota", "Reserved for same-university students", "Same university only"],
        ["MQ – Management Quota", "25% of private seats (higher fee)", "Gujarat-eligible candidates"],
        ["NRI Quota", "Max 15% of private seats", "All India candidates meeting NRI rules"]
      ]
    },
    {
      id: "nri-quota",
      type: "heading",
      title: "NRI Quota Rules",
      level: 2
    },
    {
      id: "nri-eligibility",
    ...
    {
      id: "nri-eligibility-content",
      type: "paragraph",
      content: "Candidate or parent must be an NRI. If the father is deceased, a legal guardian who is an NRI may sponsor the candidate. PIOs and OCIs are also eligible."
    },
    {
      id: "nri-documents",
      type: "heading",
    ...
    {
      id: "nri-documents-content",
      type: "paragraph",
      content: "Passport, Visa, OCI/PIO card, Embassy-issued NRI certificate, Indian & foreign address proofs, and a fee payment undertaking."
    },
    {
      id: "reservation-policy",
      type: "heading",
      title: "Reservation Policy in Gujarat PG Medical Counselling",
      level: 2
    },
    {
    ...
    },
    {
      id: "reservation-note",
      type: "paragraph",
      content: "Candidates from other states applying under the Gujarat NEET PG counselling process are only eligible for NRI seats and will be treated as Unreserved."
    },
    {
      id: "percentile-criteria",
      type: "heading",
      title: "NEET PG Percentile Criteria for Gujarat",
      level: 2
    },
    {
      id: "percentile-table",
      type: "table",
      headers: ["Category", "Cutoff Percentile"],
      rows: [
        ["SCBC, SC, ST, UR-PWD, EWS-PWD", "≥ 40 percentile"],
        ["EWS, UR", "≥ 50 percentile"]
      ]
    },
    {
      id: "percentile-note",
      type: "paragraph",
      content: "SCBC rules differ from OBC rules used in All India NEET PG counselling."
    },
    {
      id: "eligibility-criteria",
      type: "heading",
    ...
    },
    {
      ...
      type: "list",
      items: [
        "MBBS in Gujarat: Candidates who completed MBBS from a recognized Gujarat university (except AIIMS Rajkot) are eligible.",
        "MBBS Anywhere + Gujarat 12th: Candidates who studied MBBS outside Gujarat but completed Class 12th in Gujarat or were born in Gujarat.",
        "Gujarat Domicile: Candidates born in Gujarat with domicile proof can apply."
      ]
    },
    {
    ...
    },
    {
      ...
      type: "list",
      items: [
        "PIN Generation: Purchase a unique PIN online (essential to apply for NEET PG counselling registration).",
        "Registration: Fill in personal details, upload documents, and pay fees.",
        "Document Verification: Select a verification center; NRIs must verify at Gandhinagar.",
        "Merit List & Choice Filling: Follow the official NEET PG counselling schedule for choice filling and locking.",
        "Allotment: Seat allocation is based on NEET PG rank and preferences.",
        "Admission: Submit originals, pay tuition fees, and complete joining formalities."
      ]
    },
    {
      id: "fee-structure",
      type: "heading",
      title: "Fee Structure (Per Year)",
      level: 2
    },
    {
      id: "fee-table",
    ...
    },
    {
      id: "fee-note",
      type: "paragraph",
      content: "Some pre-clinical courses are priced as low as ₹1,000/year due to low demand. No bank guarantee required for future fees."
    },
    {
      id: "bond-penalty",
      type: "heading",
      title: "Bond and Penalty Details",
      level: 2
    },
    {
      id: "bond-table",
      ...
      rows: [
        ["Service Bond", "1-year compulsory bond, ₹40L penalty"],
        ["Bank Guarantee", "₹10L (for out-of-state candidates)"],
        ["Discontinuation Penalty", "50% of bond + ₹5L (clinical), ₹2L (clinical diploma), ₹1L (non-clinical)"]
      ]
    },
    {
      id: "final-tips",
      type: "heading",
      title: "Final Tips for NEET PG Career Counselling",
      level: 2
    },
    {
      id: "tips-list",
      type: "list",
      items: [
        "Don't rush registration; early applications don't improve your rank advantage.",
        "Keep all documents scanned and verified before uploading.",
        "Review the Gujarat NEET PG counselling schedule regularly to avoid missing deadlines.",
        "Understand your NEET PG rank's impact on seat availability before choice filling.",
        "Consider career counselling for NEET PG if unsure about specializations or college preferences."
      ]
    },
    {
      id: "conclusion",
      type: "paragraph",
      content: "A smooth Gujarat state NEET PG counselling experience comes from preparation and attention to detail. Follow these structured steps and make informed choices to secure your desired postgraduate medical seat."
    },
    {
      id: "faqs",
      type: "heading",
    ...
    },
    {
      ...
      faqs: [
        {
          question: "Q1. I'm not from Gujarat but did my MBBS there. Can I apply?",
          answer: "Yes. If you completed MBBS in Gujarat, you're eligible for Government and Management Quota under Gujarat PG medical counselling."
        },
        {
          question: "Q2. How to purchase the PIN?",
          answer: "Purchase a 14-digit PIN online at medadmgujarat.org to begin NEET PG counselling registration."
        },
        {
          question: "Q3. Is there separate counselling for government and private colleges?",
          answer: "No. Gujarat runs a unified process under ACPPGMEC covering both government and private institutions."
        },
        {
          question: "Q4. Are fees refundable?",
          answer: "Application (PIN) fees are non-refundable. However, the security deposit is refundable under specific conditions."
        },
        {
          question: "Q5. Can non-Gujarat candidates apply?",
          answer: "Only for NRI quota seats, if they meet the official eligibility under Gujarat NEET PG 2025 counselling."
        },
        {
          question: "Q6. What if there's an error during registration?",
          answer: "Once submitted, edits aren't allowed. Always verify data before payment."
        },
        {
          question: "Q7. When should I register?",
          answer: "Wait until the second or third day after registration opens to avoid server issues."
        },
        {
          question: "Q8. What documents are required for NRI applications?",
          answer: "Notarized passport copies, embassy certificate, sponsorship affidavit, and NRI certificate."
        }
      ]
    },
    {
...
},
{
  ...
  tags: ["NEET PG 2025", "Tamil Nadu Counselling", "Government Quota", "Medical Admissions"],
  published_date: "2025-10-25",
  read_time: 7,
  meta_description: "Complete guide to Tamil Nadu NEET PG 2025 Government Quota counselling including eligibility criteria, registration process, fee structure, and reservation policies.",
  sections: [
    {
      id: "intro",
      type: "paragraph",
      content: "Tamil Nadu offers extensive postgraduate medical education opportunities through its Government Quota counselling system. Every year, thousands of aspirants register for Tamil Nadu NEET PG counselling to secure seats in both government and private medical colleges at affordable fee structures.\n\nThis blog will provide a detailed guide to Tamil Nadu NEET PG 2025 counselling, covering eligibility criteria, the NEET PG counselling registration process, required documents, reservation policies, fee details, service bonds, and essential rules under Tamil Nadu PG medical counselling."
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        "Deadline: 16th September 2025, 5 PM"
      ]
    },
    {
      id: "timeline-note",
      type: "paragraph",
      content: "Applications must be submitted online via the official Tamil Nadu Medical Selection portal.\n\nRound-wise rules for NEET PG allotment, including choice filling, upgrades, and exits, will be announced later as part of the official NEET PG counselling schedule."
    },
    {
      id: "counselling-streams",
      type: "heading",
      title: "Separate Counselling Streams in Tamil Nadu",
      level: 2
    },
    {
      id: "streams-content",
      type: "paragraph",
      content: "Tamil Nadu state NEET PG counselling is conducted through two distinct processes:"
    },
    {
      id: "streams-list",
      type: "list",
    ...
    },
    {
      id: "streams-note",
      type: "paragraph",
      content: "Non-resident candidates who completed MBBS outside Tamil Nadu can apply under the Management Quota through Tamil Nadu medical PG counselling."
    },
    {
      id: "seats-govt-quota",
      type: "heading",
      title: "Seats Under Tamil Nadu Government Quota",
      level: 2
    },
    {
      id: "seats-content",
      type: "paragraph",
      content: "Half of the seats in government medical colleges are reserved under the Government Quota for eligible candidates. Additionally, 50% of PG seats in private medical colleges such as PSG, Vellamal, Tagore, Karpagam, and Vinayaka are available under this system.\n\nTuition fees for Government Quota seats are significantly lower compared to Management Quota, making PG counselling in Tamil Nadu one of the most affordable across India."
    },
    {
      id: "eligibility-criteria",
      type: "heading",
    ...
    {
      id: "percentile-cutoff",
      type: "heading",
      title: "Percentile Cut-off (as per NEET PG 2025)",
      level: 3
    },
    {
      id: "percentile-list",
      type: "list",
      items: [
        "OC (Open Category): 50th percentile",
        "PWD (OC): 45th percentile",
        "BC, MBC, SC, SCA, ST: 40th percentile"
      ]
    },
    {
      id: "who-eligible",
    ...
    },
    {
      ...
      type: "list",
      items: [
        "Natives of Tamil Nadu: Even if MBBS was done in another state or abroad (FMGs), you are eligible with a valid Nativity Certificate issued by the Tahsildar.",
        "MBBS Graduates from Tamil Nadu: Eligible regardless of nativity.",
        "Natives + MBBS from Tamil Nadu: Eligible under both categories."
      ]
    },
    {
      id: "not-eligible",
    ...
    },
    {
      ...
      type: "list",
      items: [
        "Non-Tamil Nadu natives who studied MBBS in other states.",
        "Candidates already pursuing or who have completed MD/MS/DNB courses."
      ]
    },
    {
      id: "reservation",
      type: "heading",
      title: "Reservation Breakdown for Government Quota",
      level: 2
    },
    {
      id: "reservation-list",
    ...
    },
    {
      ...
      type: "info-box",
      boxType: "info",
      content: "No EWS Reservation under Tamil Nadu State Quota."
    },
    {
      id: "in-service",
      type: "heading",
    ...
    },
    {
      ...
      type: "paragraph",
      content: "Half of the Government Quota seats are reserved for in-service medical professionals as per state rules. In-service candidates receive up to 30% bonus marks based on rural/primary health service.\n\nHowever, recent MRB batches may not qualify in 2025, potentially opening more seats for non-service applicants."
    },
    {
      id: "application-process",
      type: "heading",
    ...
    },
    {
      ...
      items: [
        ...
        "Complete NEET PG counselling registration online.",
        "Upload self-attested scanned documents, including your NEET PG scorecard.",
        "Pay ₹3000 application fee (exempted for SC/ST/SCA categories).",
        "You can apply for NEET PG counselling through the same portal, following the official timeline."
      ]
    },
    {
      id: "fee-structure",
    ...
    {
      id: "fee-application-content",
      type: "paragraph",
      content: "Application Fee: ₹3000 (waived for SC/ST/SCA)"
    },
    {
      id: "fee-counselling",
      type: "heading",
      title: "During Counselling (Choice Filling Stage)",
      level: 3
    },
    {
      id: "fee-counselling-list",
      type: "list",
      items: [
    ...
    },
    {
      id: "fee-tuition",
      type: "heading",
      title: "Tuition Fees (After Allotment)",
      level: 3
    },
    {
      id: "fee-tuition-list",
    ...
    },
    {
      id: "fee-note",
      type: "paragraph",
      content: "These amounts may vary slightly during the NEET PG counselling schedule release."
    },
    {
      id: "penalties-bonds",
      type: "heading",
      title: "Penalties & Bonds",
      level: 2
    },
    {
      id: "discontinuation",
      type: "heading",
      title: "Course Discontinuation",
      level: 3
    },
    {
      id: "discontinuation-content",
      type: "paragraph",
      content: "₹15 lakh penalty applies if you discontinue after Round 2. Additional penalties may apply from respective institutes."
    },
    {
      id: "bond-non-service",
      type: "heading",
      title: "Service Bond (Non-Service Candidates)",
      level: 3
    },
    {
      id: "bond-non-service-list",
      type: "list",
      items: [
        "2 years of compulsory service or ₹40 lakh penalty (MD/MS)",
        "Diploma Courses: 2 years or ₹20 lakh penalty"
      ]
    },
    {
      id: "bond-in-service",
      type: "heading",
      title: "Service Bond (In-Service Candidates)",
      level: 3
    },
    {
      id: "bond-in-service-list",
      type: "list",
      items: [
        "Service until superannuation or ₹40 lakh penalty",
        "Proportionate penalty if service is incomplete"
      ]
    },
    {
      id: "stipend",
      type: "heading",
      title: "Stipend for Residents",
      level: 3
    },
    {
      id: "stipend-list",
      ...
      items: [
        "Year 1: ₹52,451/month",
        "Expected increment to ₹54,000+ with annual 3% raise"
      ]
    },
    {
      id: "key-takeaways",
    ...
    },
    {
      ...
      type: "list",
      items: [
        "Tamil Nadu NEET PG counselling offers affordable seats under the Government Quota compared to the Management Quota.",
        "Nativity or MBBS from Tamil Nadu are the two main eligibility routes.",
        "Reservation benefits apply only to TN natives.",
        "In-service quota influences seat distribution heavily.",
        "Strict fee and bond regulations; discontinuation can result in major penalties.",
        "For aspirants, seeking NEET PG counselling guidance or NEET PG career counselling can help navigate seat preferences, eligibility, and college selection."
      ]
    },
    {
      id: "final-word",
    ...
    },
    {
      ...
      type: "paragraph",
      content: "Tamil Nadu NEET PG counselling 2025 is structured yet competitive. Ensure that your documents are ready, your registration is complete before 16th September 2025, and you've understood your NEET PG rank implications for seat selection.\n\nPlan finances for security deposits, tuition fees, and stay updated with the official notifications under the Tamil Nadu state NEET PG counselling."
    },
    {
      id: "faqs",
      type: "heading",
    ...
    },
    {
      ...
      faqs: [
        {
          question: "Q1: Who is eligible for Tamil Nadu Government Quota Counselling?",
          answer: "Tamil Nadu natives (irrespective of MBBS location) and candidates who completed MBBS from Tamil Nadu are eligible under Tamil Nadu medical pg counselling, subject to NEET PG qualification."
        },
        {
          question: "Q2: What is the application deadline?",
          answer: "Based on official updates, the deadline for Tamil Nadu NEET PG counselling 2025 registration is 18th September 2025, 5 PM."
        },
        {
          question: "Q3: What documents are required?",
          answer: "Essential documents include the NEET PG scorecard, the MBBS degree, internship completion certificate, nativity certificate (if applicable), and category certificates."
        },
        {
          question: "Q4: How many rounds of counselling are conducted?",
          answer: "The DMER typically conducts multiple rounds under the MCC NEET PG counselling framework — including stray vacancy rounds."
        }
      ]
    },
    {
...
},
{
  ...
  tags: ["NEET PG 2025", "Counselling Guide", "Course Options", "Seat Allocation", "Medical Admissions"],
  published_date: "2025-10-25",
  read_time: 8,
  meta_description: "Comprehensive guide to NEET PG 2025 counselling covering course options, institute types, seat allocation, quotas, and strategic choice filling for postgraduate medical admissions.",
  sections: [
    {
      id: "intro",
      type: "paragraph",
      content: "After months of preparation and completing NEET PG 2025, aspirants now enter the critical stage of NEET PG counselling. Unlike the exam, which tests knowledge, medical pg counselling evaluates strategy, clarity, and decision-making. Making the right choices requires a clear understanding of courses, institutes, quotas, ranks, and seat allocation. This guide covers key aspects of the NEET PG 2025 counselling framework administered by various authorities."
    },
    {
      id: "timeline",
      type: "heading",
      title: "Timeline and Expected Schedule",
      level: 2
    },
    {
      id: "timeline-list",
      type: "list",
      items: [
        "Results: Expected within 10 days of exam completion.",
        "Counselling Start: Likely by mid-September.",
        "Preparation Time: About a month after results to organize documentation, review the counselling procedure for NEET PG, and finalize seat preferences."
      ]
    },
    {
      id: "timeline-note",
      type: "paragraph",
      content: "During this period, candidates should prepare documents, review the state counselling for NEET PG notifications, and understand the seat matrix for NEET PG for informed decision-making."
    },
    {
      id: "courses",
      type: "heading",
      title: "Courses Available After NEET PG",
      level: 2
    },
    {
      id: "courses-intro",
      type: "paragraph",
      content: "Candidates can choose from multiple postgraduate pathways:"
    },
    {
      id: "courses-list",
      type: "list",
    ...
    },
    {
      id: "courses-note",
      type: "paragraph",
      content: "These courses influence your NEET PG rank and potential seat allocation under the state quota NEET PG and MCC seat matrix NEET PG."
    },
    {
      id: "institutes",
      type: "heading",
      title: "Types of Institutes Offering PG Seats",
      level: 2
    },
    {
      id: "institutes-list",
    ...
    },
    {
      id: "authorities-note",
      type: "paragraph",
      content: "Each seat is a combination of a course and an institute, with eligibility determined by NEET PG rank."
    },
    {
      id: "seat-allocation",
      type: "heading",
      title: "Seat Allocation & Rank Analysis",
      level: 2
    },
    {
      id: "closing-ranks",
      type: "heading",
      title: "Understanding Closing Ranks:",
      level: 3
    },
    {
      id: "closing-ranks-content",
      type: "paragraph",
      content: "Historical data provides reference points for NEET PG allotment patterns across categories and institutions. Choice filling in NEET PG must consider both AIQ and state quotas."
    },
    {
      id: "factors",
      type: "heading",
      title: "Factors Influencing Seat Availability:",
      level: 3
    },
    {
      id: "factors-list",
    ...
    },
    {
      ...
      type: "list",
      items: [
        "Shortlist realistic seats within your NEET PG rank range.",
        "Include backup options for lower-ranked seats.",
        "Prioritize personal factors: location, stipend, and career goals."
      ]
    },
    {
      id: "choice-note",
      type: "paragraph",
      content: "Choice lists require a careful approach to maximize success during NEET PG counselling mop-up and subsequent rounds."
    },
    {
      id: "special-institutes",
      type: "heading",
      title: "Special Institutes & Quotas",
      level: 2
    },
    {
    ...
    },
    {
      ...
      type: "list",
      items: [
        "Most seats under AIQ; some reserved for state candidates.",
        "State quota fees are often lower than AIQ fees."
      ]
    },
    {
      id: "private-hospitals",
      type: "heading",
      title: "Private Hospitals & NBEMS Quota:",
      level: 3
    },
    {
      id: "private-list",
      type: "list",
      items: [
        "Examples: Sir Ganga Ram, Apollo, Max Hospitals.",
        "Offer DNB and NBEMS diploma seats under AIQ.",
        "Sponsored in-service DNB seats are separate."
      ]
    },
    {
      id: "afms",
      type: "heading",
      title: "AFMS Institutes:",
      level: 3
    },
    {
      id: "afms-list",
      type: "list",
      items: [
        "Registration via AIQ; additional medical fitness required.",
        "Priority allocation: serving AFMS officers → civilian candidates."
      ]
    },
    {
      id: "state-private",
      type: "heading",
      title: "State Private Institutes:",
      level: 3
    },
    {
      id: "state-private-list",
      type: "list",
      items: [
        "Follow the state counselling for NEET PG rules.",
        "Check eligibility, quotas, and round-specific NEET PG choice filling allotment policies."
      ]
    },
    {
      id: "fmg",
      type: "heading",
      title: "FMG Eligibility:",
      level: 3
    },
    {
      id: "fmg-list",
      type: "list",
      items: [
        "FMGs must check state-specific rules.",
        "Some states restrict seats to domicile MBBS candidates."
      ]
    },
    {
      id: "query-support",
    ...
    },
    {
      ...
      type: "list",
      items: [
        "Query Clarification: Dedicated support, updates, and expert assistance.",
        "Documents: NEET PG scorecard, MBBS degree, internship certificate, medical registration, and category proofs.",
        "Timeline Awareness: Counselling results are usually released within 10 days after notifications."
      ]
    },
    {
      id: "conclusion",
    ...
    },
    {
      id: "conclusion-content",
      type: "paragraph",
      content: "Neet pg counselling 2025 requires careful planning, understanding courses, institutes, quotas, and smart use of NEET PG rank and seat data. Preparing documents early, analyzing past trends, and building a strategic choice, filling in the NEET PG plan maximizes chances for securing desired seats.\n\nStay informed on NEET PG counselling schedule, registration for NEET PG, and MCC seat matrix neet pg for the best results. Utilizing career counselling, NEET PG can help aspirants navigate the complex counselling procedure for NEET PG."
    },
    {
      id: "faqs",
      type: "heading",
    ...
    },
    {
      ...
      faqs: [
        {
          question: "Q1: When does NEET PG 2025 counselling begin?",
          answer: "Typically, within 4-6 weeks after the result declaration. AIQ via MCC NEET PG and state counselling rounds are notified officially."
        },
        {
          question: "Q2: What documents are required for NEET PG counselling registration?",
          answer: "Essential documents include NEET PG scorecard, MBBS degree/provisional certificate, internship completion certificate, medical registration, and category certificates."
        },
        {
          question: "Q3: How to determine seat eligibility with my rank?",
          answer: "Depends on NEET PG rank, category, state domicile, MBBS completion location, and official seat matrix for NEET PG."
        },
        {
          question: "Q4: Can FMGs participate in all state counselling?",
          answer: "Eligibility varies. Some states allow FMGs with specific schooling criteria; others restrict seats to domiciled candidates."
        }
      ]
    },
    {
...
},
{
  ...
  sections: [
    ...
    },
    {
      ...
      type: "list",
      items: [
        "Incomplete - enter start + likely completion (before July 31, 2025).",
        "Completed - enter start + end dates. Minor variations are fine."
      ]
    },
    {
      id: "medical-council",
    ...
    {
      id: "medical-council-note",
      type: "paragraph",
      content: "This step ensures compliance with official medical counselling registration norms and validates your eligibility for the NEET PG admission process and later the Indian medical counselling PG rounds."
    },
    {
      id: "mbbs-marks",
      type: "heading",
      title: "MBBS Marks & Percentage",
      level: 2
    },
    {
      id: "mbbs-marks-list",
      type: "list",
      items: [
        "Calculate using the total marks obtained by total maximum marks (not yearly averages).",
        "Enter a percentage up to two decimals.",
        "Marks are used only in tie-breaking."
      ]
    },
    {
      id: "category-reservation",
      type: "heading",
      title: "Category & Reservation Rules",
      level: 2
    },
    {
      id: "category-list",
    ...
    },
    {
      ...
      items: [
        ...
        "High-demand test centers typically reach capacity quickly during the initial NEET PG registration process period.",
        "If selecting \"Others\", allotment may be in or near your correspondence city.",
        "Candidates should consider their location on the examination date when selecting test centers."
      ]
    },
    {
      id: "document-upload",
    ...
    },
    {
      id: "document-note",
      type: "paragraph",
      content: "Mistakes can be corrected in pre-final and final edit windows."
    },
    {
      id: "payment",
      type: "heading",
    ...
    },
    {
      id: "payment-note",
      type: "paragraph",
      content: "This payment marks the final confirmation of your NEET PG 2025 registration and completion of the NEET PG application process."
    },
    {
      id: "exam-day",
      type: "heading",
    ...
    },
    {
      id: "exam-day-note",
      type: "paragraph",
      content: "Arrive early for biometric and face verification. PWD candidates using a scribe must have disability documents ready."
    },
    {
      id: "final-word",
      type: "heading",
    ...
    },
    {
      ...
      faqs: [
        {
          question: "Q1: Can I edit my application after submitting and paying the fees?",
          answer: "NBE provides limited editing windows for specific fields only. Critical information like name, email, and mobile number cannot be modified after initial submission. The edit window (May 9–13) allows changes to select fields such as test city preferences and some academic details."
        },
        {
          question: "Q2: What should I do if my payment is deducted but the application shows as incomplete?",
          answer: "If payment is deducted but status remains pending, wait 2–3 days for system processing. If the issue persists, you may need to make an alternate payment to secure your NEET PG exam registration, with the duplicate amount being refunded later by NBE."
        },
        {
          question: "Q3: Is it mandatory to complete an internship before the NEET PG 2025 exam?",
          answer: "Yes, the internship must be completed on or before July 31, 2025. Candidates with incomplete internships can apply by providing expected completion dates, but must ensure actual completion by the stipulated deadline to remain eligible for MCC NEET PG counselling registration and all India counselling NEET PG."
        }
      ]
    },
    {
...
{
  "id": 29,
  "title": "Understanding the New NRI Certificate Rules for NEET PG 2025: What Every Aspirant Must Know",
  "slug": "understanding-new-nri-certificate-rules-neet-pg-2025",
  "excerpt": "Complete guide to revised MEA NRI certificate guidelines for NEET PG 2025, covering new eligibility restrictions, documentation requirements, and impact on All India and State Quota counselling for medical aspirants.",
  ...
  "tags": ["NEET PG", "NRI Certificate", "MEA Guidelines", "NRI Quota", "Medical Counselling", "All India Quota", "State Quota", "MCC Counselling"],
  "published_date": "2025-10-31",
  "read_time": 15,
  "meta_description": "Learn about the revised MEA NRI certificate rules for NEET PG 2025 and how they affect All India and State Quota counselling eligibility and documentation.",
  "sections": [
    {
      "id": "intro",
      "type": "paragraph",
      "content": "The Ministry of External Affairs (MEA) issued revised guidelines on July 30, 2025, modifying documentation requirements for NRI certificate issuance by Indian missions abroad. These changes have significantly impacted NEET PG 2025 aspirants applying for NRI quota seats under both All India Quota Counselling (AIQ) and State Quota Counselling.\n\nA recent notification from the MEA regarding the issuance of NRI certificates has created confusion among candidates participating in NEET PG counselling, especially those under the MCC NEET PG and state-level counselling procedures. This article simplifies the new rules, eligibility, documentation, and verification process for NEET PG medical counselling 2025."
    },
    {
      "id": "understanding-nri",
      "type": "heading",
      "title": "Understanding the NRI Category in NEET PG 2025",
      "level": 2
    },
    {
      "id": "understanding-nri-content",
      "type": "paragraph",
      "content": "Before exploring the changes, it's crucial to understand how the NRI category functions in NEET PG counselling:\n\nNRI quota seats are available under:"
    },
    {
      "id": "nri-seats-list",
      "type": "list",
      "items": [
        "Deemed Universities through All India Quota Counselling (15%)",
        "Private Medical Colleges through State Quota Counselling (varies by state)"
      ]
    },
    {
      "id": "earlier-eligibility",
      "type": "paragraph",
      "content": "Earlier, candidates could apply for NRI quota seats if they were:"
    },
    {
      "id": "earlier-eligibility-list",
      "type": "list",
      "items": [
        "NRIs themselves,",
        "Children of NRIs, or",
        "Sponsored by first-degree NRI relatives (uncle, aunt, or grandparent)."
      ]
    },
    {
      "id": "new-guidelines",
      "type": "paragraph",
      "content": "Until now, most states and deemed universities accepted embassy-issued NRI certificates as valid proof for NRI quota eligibility. However, under the new MEA guidelines effective July 30, 2025, such certificates will be issued only to:"
    },
    {
      "id": "new-guidelines-list",
      "type": "list",
      "items": [
        "NRIs themselves,",
        "Children (dependents) of NRIs, and",
        "Wards of NRIs who are minors under bona fide guardianship."
      ]
    },
    {
      "id": "impact-statement",
      "type": "paragraph",
      "content": "This change directly affects adult postgraduate aspirants, who can no longer claim sponsorship under extended family relationships."
    },
    {
      "id": "old-rule",
      "type": "heading",
      "title": "The Old Rule (Till 2024)",
      "level": 2
    },
    {
      "id": "old-rule-content",
      "type": "paragraph",
      "content": "Earlier, as per the Supreme Court and the Consortium of Deemed Universities (Karnataka), first-degree relatives — including parents, siblings, uncles, aunts, and grandparents — could sponsor students for NRI quota admissions.\n\nCandidates needed:"
    },
    {
      "id": "old-rule-list",
      "type": "list",
      "items": [
        ...
        "A valid NRI certificate from the Indian Embassy, and",
        "Relationship proof."
      ]
    },
    {
      "id": "old-rule-impact",
      "type": "paragraph",
      "content": "These provisions made it easier for many students to secure NRI quota seats through family sponsorship during NEET PG counselling registration and choice filling in NEET PG rounds."
    },
    {
      "id": "new-rule",
      "type": "heading",
      "title": "The New MEA Rule (2025 Onwards)",
      "level": 2
    },
    {
      "id": "new-rule-content",
      "type": "paragraph",
      "content": "The MEA's revised policy has made NRI certificate issuance more stringent.\n\nNow, certificates for educational purposes can only be issued to:"
    },
    {
      "id": "new-rule-list",
      "type": "list",
      "items": [
        "NRIs themselves,",
        "Children of NRIs, and",
        "Minor wards under guardianship (not applicable to postgraduate candidates)."
      ]
    },
    {
      "id": "new-rule-impact",
      "type": "paragraph",
      "content": "This means that extended family sponsorships — a common route in earlier NEET PG counselling procedures — are no longer valid.\n\nAdult NEET PG aspirants can apply under the NRI quota only if they or their parents hold NRI status with valid embassy documentation."
    },
    {
      "id": "impact-counselling",
      "type": "heading",
    ...
    },
    {
      "id": "all-india-quota",
      "type": "heading",
      "title": "1. All India Quota Counselling (Deemed Universities)",
      "level": 3
    },
    {
      "id": "all-india-quota-content",
      "type": "paragraph",
      "content": "Deemed universities allot 15% of seats under the NRI quota through MCC NEET PG counselling.\n\nWith the new MEA restrictions, only direct NRIs or children of NRIs will be eligible. Sponsorship through uncles, aunts, or grandparents is no longer accepted for All India Counselling."
    },
    {
      "id": "state-quota",
      "type": "heading",
    ...
    },
    {
      ...
      "type": "paragraph",
      "content": "In state quota counselling, each state medical authority has its own set of documentation requirements. Some states, such as Kerala, may accept alternate proofs, while others — like Tamil Nadu, Karnataka, and Maharashtra — strictly follow embassy certification norms.\n\nWithout a valid NRI certificate, applicants will be ineligible to apply under the NRI category during NEET PG state counselling."
    },
    {
      "id": "conversion-seats",
      "type": "heading",
      "title": "3. Conversion of NRI Seats",
      "level": 3
    },
    {
      "id": "conversion-seats-content",
      "type": "paragraph",
      "content": "In later rounds (especially Round 3 of MCC NEET PG counselling), NRI seats often convert into management seats if left vacant. Due to new documentation limits, this conversion may occur faster, as fewer candidates now qualify under the NRI category."
    },
    {
      "id": "documentation",
      "type": "heading",
      "title": "Documentation Required for NRI Category (NEET PG 2025)",
      "level": 2
    },
    {
      "id": "documentation-content",
      "type": "paragraph",
      "content": "When applying for NEET PG counselling registration under the NRI category, candidates must prepare:"
    },
    {
      "id": "documentation-list",
      "type": "list",
      "items": [
        "Valid passport and proof of NRI status (self or parent)",
        "Embassy-issued NRI certificate (valid for one academic year)",
        "Affidavit of relationship and family tree document",
        "NEET PG 2025 scorecard",
        "Affidavit in MEA-approved format (issued within six months)",
        "Self-declaration form"
      ]
    },
    {
      "id": "documentation-important",
      "type": "paragraph",
      "content": "Important:"
    },
    {
      "id": "documentation-important-list",
      "type": "list",
      "items": [
        "The NRI certificate is valid only for one admission cycle.",
        "Certificates from the previous academic session cannot be reused."
      ]
    },
    {
      "id": "documentation-note",
      "type": "paragraph",
      "content": "These are essential for apply for NEET PG counselling under the NRI category."
    },
    {
      "id": "common-issues",
      "type": "heading",
      "title": "Common Issues Faced by NEET PG 2025 Candidates",
      "level": 2
    },
    {
      "id": "issue-1",
      "type": "heading",
      "title": "1. Extended Family Sponsorship Rejection",
      "level": 3
    },
    {
      "id": "issue-1-content",
      "type": "paragraph",
      "content": "Applications sponsored by uncles, aunts, or cousins are being rejected since adult candidates no longer qualify as \"wards.\""
    },
    {
      "id": "issue-2",
      "type": "heading",
      "title": "2. Strict Verification by Embassies",
      "level": 3
    },
    {
      "id": "issue-2-content",
      "type": "paragraph",
      "content": "Many embassies now require direct parental proof of NRI status and bona fide guardianship documents — valid only for minors."
    },
    {
      "id": "issue-3",
      "type": "heading",
      "title": "3. Document Validity Concerns",
      "level": 3
    },
    {
      "id": "issue-3-content",
      "type": "paragraph",
      "content": "Certificates older than a year or lacking the admission year are rejected during MCC NEET PG counselling registration."
    },
    {
      "id": "issue-4",
      "type": "heading",
      "title": "4. Delay in Counselling",
      "level": 3
    },
    {
      "id": "issue-4-content",
      "type": "paragraph",
      "content": "Embassy verification delays are causing setbacks in NEET PG counselling schedule and seat allotment."
    },
    {
      "id": "priority",
      "type": "heading",
      "title": "Priority in NRI Seat Allotment (Revised)",
      "level": 2
    },
    {
      "id": "priority-list",
      "type": "list",
      "items": [
        "Priority 1: NRIs and children of NRIs",
        "Priority 2: Sponsored wards or relatives of NRIs"
      ]
    },
    {
      "id": "priority-note",
      "type": "paragraph",
      "content": "However, under the new MEA NRI certificate rule, Priority 2 candidates may lose eligibility, limiting their participation in career counselling NEET PG rounds."
    },
    {
      "id": "expert-advice",
      "type": "heading",
      "title": "Expert Advice for NEET PG 2025 Aspirants",
      "level": 2
    },
    {
      "id": "expert-advice-content",
      "type": "paragraph",
      "content": "If you are applying for NRI quota seats, here's what you should do:"
    },
    {
    ...
    {
      "id": "expert-advice-warning",
      "type": "paragraph",
      "content": "A single discrepancy can lead to seat forfeiture and debarment from future NEET PG career counselling rounds."
    },
    {
      "id": "conclusion",
      "type": "heading",
    ...
    },
    {
      "id": "conclusion-content",
      "type": "paragraph",
      "content": "The 2025 MEA guidelines have reshaped NRI quota eligibility for NEET PG 2025 counselling, affecting both All India and State Quota Counselling processes.\n\nBy restricting eligibility to NRIs and their children, the government aims to ensure transparency in NEET PG medical counselling. However, it also narrows opportunities for candidates dependent on extended family sponsorship.\n\nStay informed, stay compliant, and follow verified updates on MCC NEET PG counselling, state counselling notifications, and NRI certificate requirements to avoid last-minute surprises."
    },
    {
      "id": "faqs",
      "type": "heading",
    ...
    },
    {
      ...
      "faqs": [
        {
          "question": "Q1: What changed in the NRI certificate rules for NEET PG 2025?",
          "answer": "A: MEA revised guidelines on July 30, 2025, restrict embassy-issued NRI certificates to: (1) NRIs themselves, (2) Children of NRIs, (3) Minor wards under bona fide guardianship. NEET PG candidates (adults 21+) cannot obtain certificates through extended family (uncles, aunts, cousins, grandparents)."
        },
        {
          "question": "Q2: Who can sponsor a NEET PG candidate for the NRI quota now?",
          "answer": "A: Only parents (father/mother) who are NRIs can sponsor adult NEET PG candidates. Extended family sponsorship (uncles, aunts, grandparents, cousins) no longer valid due to the \"minor ward\" restriction in MEA guidelines. OCI/PIO holders are exempt from sponsorship restrictions."
        },
        {
          "question": "Q3: What documents are required for the NRI quota?",
          "answer": "A: NEET PG admit card + scorecard, valid passport/visa/residence permit/work permit of parent/candidate, embassy-issued NRI certificate, family tree certificate from revenue authority, notarized affidavit from NRI sponsor with NRE bank passbook, 10th/12th certificates, birth certificate. Deadline: October 28, 2025, 12 PM via nri.adgmemcc1@gmail.com."
        },
        {
          "question": "Q4: How does this affect All India and State counselling?",
          "answer": "A: All India (Deemed Universities): 15% NRI seats now restricted to direct NRI status or children of NRIs. State Counselling: Most states (TN, Karnataka, Maharashtra) require embassy certificates; rejection impacts eligibility. Priority 1: NRI/children of NRI. Priority 2: Relatives (likely ineligible due to adult status)."
        },
        {
          "question": "Q5: What happens if fraudulent documents are submitted?",
          "answer": "A: MCC verifies all NRI documents with originating Indian missions post-admission. Consequences: Admission cancellation, seat forfeiture, multi-year debarment from counselling. MEA-mandated verification increased after widespread document fraud cases. Validity: NRI certificate valid for one year only; prior year certificates are inadmissible."
        }
      ]
    },
    {
  ...
  "sections": [
    {
      "id": "intro",
      "type": "paragraph",
      "content": "The Uttar Pradesh (UP) NEET PG counselling, you know what, is one of the most important steps for postgraduate medical aspirants who are desperately aiming for MD, MS, Diploma, or MDS courses in state and private medical colleges, respectively. This has been conducted via the official portal https://upneet.gov.in. This has been determined that the admissions are based on NEET PG/MDS results, eligibility, home status, and the candidate's personal preferences.\n\nThis complete guide perfectly explains everything about the UP NEET PG 2025 counselling, which starts from the candidate's eligibility criteria and their registration steps to bond rules, refund policies, and the entire counselling procedure."
    },
    {
      "id": "eligibility-criteria",
      "type": "heading",
      "title": "Eligibility Criteria for UP NEET PG Counselling",
      "level": 2
    },
    {
      "id": "eligibility-intro",
    ...
    },
    {
      "id": "percentile-criteria",
      "type": "heading",
      "title": "B. NEET PG Percentile Criteria for UP",
      "level": 3
    },
    {
      "id": "percentile-table",
    ...
    },
    {
      "id": "percentile-note",
      "type": "paragraph",
      "content": "Candidates who have 40–50 percentiles are eligible only for reserved category seats."
    },
    {
      "id": "educational-qualification",
      "type": "heading",
      "title": "C. Educational Qualification & Internship",
      "level": 3
    },
    {
    ...
    {
      "id": "other-general-criteria-list",
      "type": "list",
      "items": [
    ...
    },
    {
      ...
      "type": "heading",
      "title": "UP NEET PG Counselling Procedure: Step-by-Step",
      "level": 2
    },
    {
      "id": "counselling-procedure-intro",
      "type": "paragraph",
      "content": "You know that the overall NEET PG counselling procedure for Uttar Pradesh has been conducted online. Below is a simplified breakdown of the process:"
    },
    {
      "id": "step-1",
      "type": "heading",
      "title": "Step 1: Notification / Brochure Release",
      "level": 3
    },
    {
      "id": "step-1-content",
      "type": "paragraph",
      "content": "Candidates must know that the Directorate of Medical Education releases a brochure that has the complete NEET PG counselling schedule, along with all eligibility norms, seat matrix, and fee details. They just have to read it thoroughly before doing the registration."
    },
    {
      "id": "step-2",
      "type": "heading",
      "title": "Step 2: Registration / Candidate Login",
      "level": 3
    },
    {
      "id": "step-2-content",
    ...
    },
    {
      "id": "step-3",
      "type": "heading",
      "title": "Step 3: Security Deposit Payment",
      "level": 3
    },
    {
      "id": "step-3-content",
      "type": "paragraph",
      "content": "Simply, the refundable security deposits fluctuate by seat type: ₹30,000 for the government seats. On the other hand, the ₹2,00,000 private seats, per 2025 brochure."
    },
    {
      "id": "step-4",
      "type": "heading",
      "title": "Step 4: Document Upload & Verification",
      "level": 3
    },
    {
      "id": "step-4-content",
    ...
    },
    {
      "id": "step-5",
      "type": "heading",
      "title": "Step 5: Choice Filling & Locking",
      "level": 3
    },
    {
      "id": "step-5-content",
      "type": "paragraph",
      "content": "This is the most crucial part of the choice filling in the NEET PG process. Candidates must carefully select and prioritize their desired courses and colleges that are based on the available NEET PG counselling seat matrix.\n\nOverall, once candidates' choices have been finalized, they just lock them before the deadline coming up. Although it is just a reminder that locked choices cannot be modified later, so do it earlier."
    },
    {
      "id": "step-6",
      "type": "heading",
      "title": "Step 6: Seat Allotment / Result",
      "level": 3
    },
    {
      "id": "step-6-content",
    ...
    },
    {
      "id": "step-7",
      "type": "heading",
      "title": "Step 7: Reporting & Joining",
      "level": 3
    },
    {
      "id": "step-7-content",
      "type": "paragraph",
      "content": "Report physically to the allotted college with the candidate's original document, the allotment letter, and the final fee payment proof."
    },
    {
      "id": "step-8",
      "type": "heading",
      "title": "Step 8: Subsequent Rounds / Mop-up / Stray Vacancy",
      "level": 3
    },
    {
      "id": "step-8-content",
      "type": "paragraph",
      "content": "After Round 1 and Round 2 happened, if the candidate's seats remain empty, a mop-up round NEET PG and stray counselling NEET PG are conducted.\n\nThe registered candidates who have already paid the security deposit can participate again as well. The mop-up NEET PG result, cutoff, and seat matrix are updated on the official portal; they just have to check properly."
    },
    {
      "id": "refund-policy",
      "type": "heading",
    ...
    },
    {
      ...
      "type": "paragraph",
      "content": "The refund policy primarily concerns the security deposit made during registration."
    },
    {
      "id": "refund-table",
      "type": "table",
    ...
    },
    {
      "id": "final-thoughts-content",
      "type": "paragraph",
      "content": "The UP NEET PG counselling process is more than just a registration form — it's a structured pathway to your postgraduate dream seat. From mop-up round seat allotment to stray round vacancy filling, every phase matters.\n\nWhether you're exploring UP state NEET PG counselling or participating in MCC PG medical counselling, stay updated, make informed decisions, and fill your choices wisely. Your journey to specialization begins here."
    },
    {
      "id": "faqs",
      "type": "heading",
...
{
  "id": 46,
  "title": "Uttar Pradesh NEET PG Counselling 2025: Eligibility, Seats, Reservation, and Fee Details",
  "slug": "uttar-pradesh-neet-pg-counselling-2025-eligibility-seats-reservation-fee",
  "excerpt": "UP NEET PG 2025 guides aspirants with clear rules on eligibility, seat distribution, reservation and fees, helping students plan their medical careers confidently.",
  ...
  "read_time": 14,
  "meta_description": "UP NEET PG 2025 guides aspirants with clear rules on eligibility, seat distribution, reservation and fees, helping students plan their medical careers confidently.",
  "sections": [
    {
      "id": "intro",
      "type": "paragraph",
      "content": "The Uttar Pradesh NEET PG Counselling 2025 will be conducted by the Directorate General of Medical Education (DGME), Uttar Pradesh. This is basically essential for admission to MD, MS, and PG Diploma courses across all the government and private medical colleges in the state."
    },
    {
      "id": "intro-purpose",
      "type": "paragraph",
      "content": "So, if you're planning to apply for postgraduate medical seats in UP, here's a complete breakdown of that, which includes the eligibility criteria, seat distribution, reservation policy, important certificates that are required, and fee details. Here are some important things to know before registration, especially for those preparing for Uttar Pradesh NEET PG 2025 counselling."
    },
    {
      "id": "seat-distribution",
      "type": "heading",
      "title": "Seat Distribution in Uttar Pradesh NEET PG Counselling",
      "level": 2
    },
    {
      "id": "seat-distribution-intro",
      "type": "paragraph",
      "content": "The process of seat distribution that covers both Government and Private medical colleges under the state quota. This is the same seat classification followed across major NEET PG counselling seat matrix systems."
    },
    {
      "id": "seat-distribution-details",
      "type": "paragraph",
      "content": "Here's how the seats are divided:"
    },
    {
      "id": "seat-distribution-list",
      "type": "list",
      "items": [
        "Half of the seats (50%) of seats in Government Medical Colleges fall under the State Government Quota.",
        "On the other hand, 100% of seats in Private Medical Colleges come under the State Counselling Quota.",
        "There are no All India Quota seats that are specifically managed under this process; they are handled separately by MCC."
      ]
    },
    {
    ...
    },
    {
      ...
      "rows": [
        ["UR / EWS", "50th percentile"],
        ["UR-PwD / EWS-PwD", "45th percentile"],
    ...
    },
    {
      "id": "ineligibility",
      "type": "heading",
      "title": "Ineligibility Criteria",
      "level": 2
    },
    {
      "id": "ineligibility-intro",
      "type": "paragraph",
      "content": "Certain candidates are not permitted to participate in UP NEET PG Counselling 2025:"
    },
    {
      "id": "ineligibility-list",
      "type": "list",
      "items": [
        "Those allotted seats in the Stray Vacancy Round of 2024 but did not join.",
        "Candidates who discontinued a PG course in UP after joining in 2024.",
        "Candidates currently pursuing or have failed a PG course elsewhere in India."
      ]
    },
    {
    ...
    },
    {
      ...
      "items": [
        ...
        "Category 2: MBBS graduates from Private Medical Colleges of Uttar Pradesh.",
        "Category 3: MBBS graduates from State Private Universities of Uttar Pradesh (including Santosh University)."
      ]
    },
    {
      "id": "seat-split",
    ...
    },
    {
      "id": "seat-split-table",
      "type": "table",
      "headers": ["Type of Institution", "Category", "Eligibility", "Seat Share"],
      "rows": [
        ["Government Colleges", "The State Govt Seats", "They must be qualified with their MBBS from Uttar Pradesh*", "50%"],
        ["Private Minority Colleges", "The Minority Quota", "Minority candidates (All India basis)", "50%"],
        ["Private Colleges (Open Category)", "The Open Quota", "All India candidates", "100%"]
      ]
    },
    {
      "id": "reservation-policy",
      "type": "heading",
      "title": "Reservation Policy in Uttar Pradesh PG Counselling",
      "level": 2
    },
    {
      "id": "reservation-intro",
    ...
    },
    {
      ...
      "items": [
        ...
        "Pay the registration fee online.",
        "Fill in details like domicile, category, sub-category, and in-service (PMHS) status.",
    ...
    },
    {
      ...
      "rows": [
        ["Registration Fee", "₹3,000", "Mandatory for all candidates during Round 1 registration."],
        ["Stray Vacancy Round Fee", "₹3,000", "If applicable (for candidates eligible for the stray round)."],
        ["Security Deposit", "₹30,000", "For Government seats."],
        ["Security Deposit", "₹2,00,000", "For opting for both Government + Private seats."]
      ]
    },
    {
      "id": "fees-note",
    ...
    },
    {
      ...
      "items": [
        ...
        "NEET PG Scorecard: For the NEET PG scorecard, you need to carry the original scorecard, and a photocopy is required to confirm your qualifying marks.",
        "Proof of Date of Birth: You have to submit your Class 10 (SSLC) certificate, as it serves as valid proof of birth date.",
        "MBBS Degree or Provisional Certificate: Either the final MBBS degree or a provisional degree certificate issued by your university must be produced.",
        "MBBS Mark Sheets (All Years): Carry mark sheets for every academic year of your MBBS course, originals and one photocopy each.",
        "Internship Completion Certificate: Proof that you've completed your CRRI (internship) period is mandatory.",
        "Permanent Registration Certificate: For the submission of a permanent registration certificate, you need to submit your registration certificate from the State Medical Council or the National Medical Commission (NMC).",
        "Caste or EWS Certificate (if applicable): All the candidates who need to apply under SC, ST, OBC, or EWS categories must provide a valid community certificate. This is especially for OBC/EWS candidates, for whom the certificates issued on or after April 1, 2025, will be accepted.",
        "PwD (Persons with Disability) Certificate (if applicable): Submit the official disability certificate issued only by government-recognized medical boards or authorized centers.",
        "Allotment Letter: Print out your official allotment letter from the counselling portal and attach a self-attested copy with it."
      ]
    },
    {
      "id": "service-bond",
      "type": "heading",
      "title": "Service Bond and Penalty (Government Seats)",
      "level": 2
    },
    {
      "id": "service-bond-list",
      "type": "list",
      "items": [
        "Bond Duration: 2 years of compulsory service.",
        "Bond Amount: ₹40 lakhs penalty for discontinuation or non-completion.",
        "In-service Candidates: 10-year bond or ₹2 crore penalty (for those under State Quota).",
        "Course Discontinuation: No monetary penalty since 2024, but debarred for one academic year."
      ]
    },
    {
      "id": "stipend",
      "type": "heading",
      "title": "Stipend (Government Colleges)",
      "level": 2
    },
    {
      "id": "stipend-table",
      "type": "table",
      "headers": ["Year", "Approx. Stipend (₹ per annum)"],
      "rows": [
        ["1st Year", "₹1,09,955"],
        ["2nd Year", "₹1,13,808"],
        ["3rd Year", "₹1,16,970"]
    ...
    },
    {
      ...
      "faqs": [
        {
          "question": "Q1: What is the registration fee for UP NEET PG 2025?",
          "answer": "The registration fee would be ₹3,000, mandatory for all candidates, especially in round 1. All the relevant payments are to be made online by Net Banking, Credit Card, or Debit Card only."
        },
        {
          "question": "Q2: Who is eligible for UP State Quota seats?",
          "answer": "All the MBBS graduates specific platforms of government or private colleges in Uttar Pradesh are highly eligible for UP State Quota seats. Although candidates who have completed their MBBS from outside UP are highly eligible for only private college seats."
        },
        {
          "question": "Q3: What is the minimum NEET PG percentile for UR/EWS candidates in UP 2025?",
          "answer": "The minimum NEET PG percentile for UR/EWS candidates in UP 2025 is 50% percentile."
        },
        {
          "question": "Q4: What is the service bond for government PG seats in UP?",
          "answer": "It should be for 10 years, where regular PG candidates must serve 2 years; there will be penalties for non-completion, which are of ₹40 lakh (regular) or ₹2 crore (in-service)."
        },
        {
          "question": "Q5: What documents are required for counselling and admission?",
          "answer": "The documents which are required for counselling are that you must carry your NEET PG admit card, scorecard, MBBS degree/certificate, MBBS mark sheets, internship completion certificate, registration certificate, and category/EWS/PwD certificate (if applicable), along with your allotment letter. These are all highly required."
        }
      ]
    },
    {
  ...
  "sections": [
    ...
    },
    {
      ...
      "rows": [
        ...
        ["5", "(NBEMS) Nuclear Medicine", "3"],
        ["6", "(NBEMS) Radio-Diagnosis", "31"],
        ["7", "M.D. (Anaesthesiology)", "1"],
        ["8", "M.D. (Dermatology / Venerology / Leprosy / Skin & Venereal Diseases)", "67"],
        ["9", "M.D. (General Medicine)", "373"],
        ["10", "M.D./M.S. (Obstetrics & Gynaecology)", "39"],
        ["11", "M.D. (Paediatrics)", "36"],
        ["12", "M.D. (Psychiatry)", "2"],
        ["13", "M.D. (Radio-Diagnosis)", "279"],
        ["14", "M.D. (Nuclear Medicine)", "8"],
        ["15", "M.S. (Ophthalmology)", "3"],
        ["16", "M.S. (ENT)", "1"],
...
},
{
  ...
  "read_time": 18,
  "meta_description": "Aspirants get a clear guide to Haryana NEET PG 2025 covering registration eligibility and a simple process that helps secure the right postgraduate seat.",
  "sections": [
    {
      "id": "intro",
      "type": "paragraph",
    ...
    },
    {
      "id": "important-dates",
      "type": "heading",
      "title": "Important Dates for Haryana NEET PG Counselling 2025",
      "level": 2
    },
    {
      "id": "important-dates-list",
      "type": "list",
      "items": [
        "Official Website: https://dmer.haryana.gov.in/",
        "Counselling Portal: https://hry.online-counselling.co.in/",
        "Candidate Login: https://hry.online-counselling.co.in/login"
      ]
    },
    {
    ...
    },
    {
      "id": "eligibility-criteria",
      "type": "heading",
      "title": "Who Can Apply? (Eligibility Criteria)",
      "level": 2
    },
    {
      "id": "eligibility-intro",
    ...
    },
    {
      "id": "minimum-scores",
      "type": "heading",
      "title": "Minimum NEET PG 2025 Scores Required",
      "level": 2
    },
    {
    ...
    },
    {
      "id": "important-alerts",
      "type": "heading",
      "title": "Before You Start: Important Alerts on the Portal",
      "level": 2
    },
    {
      "id": "important-alerts-content",
      "type": "paragraph",
    ...
    },
    {
      "id": "registration-process",
      "type": "heading",
      "title": "Step-by-Step Registration Process for Haryana NEET PG 2025",
      "level": 2
    },
    {
      "id": "registration-process-intro",
    ...
    },
    {
      ...
      "items": [
        ...
        "Temporary password (On both email & SMS)"
      ]
    },
    {
      "id": "step-5-note",
    ...
    },
    {
      ...
      "type": "heading",
      "title": "Application Form Sections Inside the Portal",
      "level": 2
    },
    {
    ...
    {
      "id": "registration-details-content",
      "type": "paragraph",
    ...
    {
      "id": "registration-details-quota-list",
      "type": "list",
      "items": [
        "State Quota",
        "Private Quota",
    ...
    {
      "id": "qualification-details-content",
      "type": "paragraph",
