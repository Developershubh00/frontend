...
interface FeesStipendBondPage2025Props {
  onBack: () => void;
}
...
const FeesStipendBondPage2025: React.FC<FeesStipendBondPage2025Props> = ({
  onBack,
}) => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "/data/neetPgData/fee_stipend_and_bond_2025.csv",
        );
...
export default FeesStipendBondPage2025;
