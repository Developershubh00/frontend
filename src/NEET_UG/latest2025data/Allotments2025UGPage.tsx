...
interface Allotments2025UGPageProps {
  onBack: () => void;
}
...
const Allotments2025UGPage: React.FC<Allotments2025UGPageProps> = ({
  onBack,
}) => {
  ...
  useEffect(() => {
    setLoading(true);
    fetch("/data/Allotments2025UG.csv")
      .then((r) => {
      ...
      <div className="flex-1 flex flex-col">
        ...
        {dataError && (
          <div className="bg-amber-50 border-b border-amber-200 px-4 py-2 text-xs text-amber-700 text-center">
            ...
            <code>/public/data/Allotments2025UG.csv</code> to enable this page.
          </div>
        )}
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {paged.length === 0 ? (
                <tr>
                  ...
                  >
                    {dataError
                      ? "2025 CSV not found — add /public/data/Allotments2025UG.csv to enable this page."
...
export default Allotments2025UGPage;
