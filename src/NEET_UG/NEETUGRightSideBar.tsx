...
const NEETUGRightSideBar: React.FC<NEETUGRightSideBarProps> = ({
  ...
  const NEETUGTimeline = [
    ...
    // {
    //   id: 6,
    //   date: "July 21 - October 2025",
    //   event: "MCC Counselling Rounds",
    //   status: "completed",
    // },
    {
      id: 7,
  ...
  return (
    <div className="h-full w-80 bg-white/95 backdrop-blur-xl border-l border-slate-200/50 z-30 overflow-y-auto">
      <div className="p-4 pt-4 space-y-6">
        ...
        {/* Exam Notice */}
        <div className="bg-red-50 border-l-4 border-red-500 text-red-800 p-3 rounded text-xs shadow-sm">
          <p className="font-bold mb-1 flex items-center gap-1">
            <span>📢</span> RE-NEET UG 2026 Notice
          </p>
          <p className="leading-relaxed">
            The RE-NEET UG 2026 exam is scheduled for{" "}
            <strong>June 21, 2026</strong> from 2:00 PM to 5:15 PM. Admit cards
            will be available on the official NTA website.
          </p>
        </div>
