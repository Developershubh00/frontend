...
const NotificationsPage: React.FC = () => {
  ...
  const filterOptions = [
    { id: 'all', label: 'All', count: notificationsData.length },
    { id: 'unread', label: 'Unread', count: unreadCount },
    { id: 'urgent', label: 'Urgent', count: notificationsData.filter(n => n.type === 'urgent').length },
    { id: 'info', label: 'Info', count: notificationsData.filter(n => n.type === 'info').length },
  ];
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm lg:text-base">
                    {unreadCount} unread notification{unreadCount !== 1 ? 's' : ''} • {notificationsData.length} total
                  </p>
                </div>
              </div>
            </div>
