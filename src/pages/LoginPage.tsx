...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-150 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/30">
          {/* Logo and Header */}
          <div className="text-center mb-8">
            <div className="space-y-2 mb-4 bg-white rounded-3xl flex items-center justify-center shadow-xl mx-auto mb-6 ring-2 ring-blue-100">
              <img
                src="/media/logo3.png"
                alt="BD Logo"
