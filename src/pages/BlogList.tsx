...
const BlogList: React.FC = () => {
  ...
  // ✅ NEW: Add this blog list schema
  const blogListSchema = {
    "@context": "https://schema.org",
    "@type": "Blog",
    name: "Believers Consultancy Blog",
    description:
      "Expert insights, latest updates, and comprehensive guides for your medical education journey",
    url: "https://believersconsultancy.com/blog",
    publisher: {
      "@type": "Organization",
  ...
  const getExcerpt = (sections: any[], wordLimit = 25): string => {
    if (!sections || !Array.isArray(sections)) return "";

    // Collect text only from paragraph type sections
    const paragraphTexts = sections
    ...
    const words = paragraphTexts.split(" ");
  ...
  return (
    <>
      {/* ✅ NEW: SEO Components - Add these 3 lines */}
      <SEOHead
        title="Blog - NEET PG Counselling Guides & Medical Admission Tips | Believers Consultancy"
        description="Expert insights, latest updates, and comprehensive guides for NEET PG, INICET, medical college admissions, and career guidance for medical aspirants."
        keywords="NEET PG blog, medical admission guides, INICET counselling, NEET counselling tips, medical education blog, NEET PG updates"
        canonical="https://believersconsultancy.com/blog"
        ogImage="https://cdn.dribbble.com/userupload/45206464/file/c3151a13076f702ddb0d22c361a63bd.png"
      />
      <JsonLd data={blogListSchema} id="blog-list" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="text-center">
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Expert insights, latest updates, and comprehensive guides for
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    ...
                    <div className="p-8 lg:p-12 flex flex-col justify-center">
                      <div className="flex items-center gap-4 mb-4">
                        <span
                          className={`px-3 py-1 rounded-full text-sm font-medium ${featuredPost.category.color}`}
                        >
                      ...
                      <p className="text-gray-600 text-base mb-6 leading-relaxed">
                        {getExcerpt(featuredPost.sections)}
                      </p>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="bg-gradient-to-r from-blue-500 to-red-500 text-white px-6 py-3 rounded-full font-semibold hover:scale-105 transition-transform duration-200 inline-flex items-center">
                          Read More
              ...
              <div className="flex flex-col lg:flex-row gap-6 items-center">
                <div className="relative flex-1 w-full">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border text-black border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    value={searchTerm}
          ...
          <section>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {displayedPosts.map((post) => (
                <article
                  key={post.id}
                  className="bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105 group"
                >
                  <Link to={`/blog/${post.slug}`} className="block">
                        ...
                        <div className="relative">
                          <button
                            onClick={(e) => {
                              e.preventDefault();
                              setShareMenuOpen(
                                shareMenuOpen === post.id ? null : post.id,
                              );
                            }}
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                        ...
                        <div className="text-blue-600 hover:text-blue-700 font-semibold text-sm flex items-center">
            ...
            {hasMorePosts && (
              <div className="flex justify-center mt-12">
                <button
                  ...
                  className="bg-gradient-to-r from-blue-500 to-red-500 text-white px-8 py-4 rounded-full font-semibold hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-3"
                >
                  {loadingMore ? (
                    <>
