...
//       setFeaturedPost(sortedPosts[0]); // First (newest) post as featured
//       setLoading(false);
//     };
...
//   // Get posts to display based on visiblePosts count
...
const BlogList: React.FC = () => {
  ...
  const blogListSchema = {
    ...
    "description": "Expert insights, latest updates, and comprehensive guides for your medical education journey",
