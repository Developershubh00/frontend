...
const AnnouncementSidebar: React.FC<AnnouncementSidebarProps> = ({ onAnnouncementClick }) => {
  ...
  const mockAnnouncements: AnnouncementSummary[] = [
    ...
    },
    {
     ...
     {
      id: 82,
      title: "MCC NEET PG Counselling 2025 Round 2 Choice Filling Halted Today 2 PM–6 PM for Seat Matrix Update; Fresh Vacant Seats to Be Added, Choice Filling and Locking Extended Till 11:55 PM on December 12 at mcc.nic.in",
     ...
     {
      id: 83,
      title: "NEET PG 2025 Round 2 Choice Filling, Locking Available Till 1 PM on 13 December – Check Final Timings",
    ...
    {
          id: 85,
          title: "NEET PG 2025 Round 2 Provisional Seat Allotment Result Released for All India Quota",
     ...
     {
      id: 90,
      title: "NEET PG 2025 Counselling: MCC Extends Round 2 Reporting & Resignation Deadline Till December 29, 4 PM at mcc.nic.in",
