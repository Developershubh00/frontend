...
const AnnouncementSidebar: React.FC<AnnouncementSidebarProps> = ({
  ...
  const mockAnnouncements: AnnouncementSummary[] = [
    ...
    },
    {
      id: 4,
      title:
        "NEET PG 2025 counselling dates coming soon; Supreme Court hears ‘transparency’ plea today.",
      date: "2025-09-11T10:30:00Z",
      priority: "medium",
      category: "NEET PG",
      source: "Times OF India",
    ...
    // },
    {
      id: 8,
      title:
        "NEET PG 2025: Counselling dates to be announced; 50% AIQ merit list released, with answer key and cutoff updates.",
    ...
    // },
    {
      id: 9,
      title:
        "NEET PG 2025: Supreme Court declines to pause counselling; transparency plea listed for hearing next week.",
      date: "2025-09-06T10:30:00Z",
      priority: "medium",
      category: "NEET PG",
    ...
    },
    {
      id: 10,
      title:
        "NEET PG merit list for 50% AIQ seats out; counselling schedule to follow",
    ...
    },
    {
      id: 11,
      title:
        "Gujarat NEET PG counselling 2025 opens for registration/PIN; tie‑breaking used for 211 applicants.",
      date: "2025-09-05T10:30:00Z",
      priority: "high",
      category: "NEET PG",
    ...
    },
    {
      id: 12,
      title:
        "NEET PG 2025 Counselling Dates & Schedule Soon; SC to Hear 'Transparency' Plea Today",
    ...
    },
    {
      id: 13,
      title:
        "NEET PG 2025 scorecards are now live on the NBEMS portal; candidates may log in to view and download their scorecard/response sheet.",
    ...
    },
    {
      id: 14,
      title:
        "MCC Yet to Announce NEET PG 2025 Counselling Schedule- Here's How to Check The official NEET PG 2025 AIQ counselling schedule from MCC is still awaited. Candidates must monitor mcc.nic.in for the official PDF and dates.",
    ...
    },
    {
      id: 15,
      title:
        "Deadline Today: Tamil Nadu NEET PG 2025 Counselling Applications Close at 5 PMTN NEET PG 2025: Final Call for State Counselling Registration",
    ...
    },
    {
      id: 18,
      title:
        "NEET PG 2025: Supreme Court to hear answer key transparency plea on September 23NEET PG Counselling 2025: SC Reschedules Hearing On Answer Key Transparency To September ",
    ...
    },
    {
      id: 19,
      title:
        "NEET PG 2025: Supreme Court to hear plea on score discrepancies today",
    ...
    },
    {
      id: 20,
      title:
        "NEET PG 2025: Supreme Court lists transparency plea for hearing on September 23",
      date: "2025-09-21T12:30:00Z",
      priority: "high",
      category: "NEET PG",
    ...
    },
    {
      id: 23,
      title:
        "Supreme Court Telangana HC Permits NEET PG Registration Under NRI Quota for OCI  ",
      date: "2025-09-23T08:00:00Z",
      priority: "high",
      category: "NEET PG",
    ...
    },
    {
      id: 24,
      title:
        "NEET PG 2025 Transparency Hearing Before Supreme Court Today The Supreme Court is hearing a critical plea from NEET PG 2025 candidates who are demanding complete transparency in the scoring process. Aspirants are seeking the full disclosure of question papers and scores to ensure fairness and allow for proper verification of their results.  ",
      date: "2025-09-23T08:00:00Z",
      priority: "high",
      category: "NEET PG",
    ...
    },
    {
      id: 25,
      title:
        "Supreme Court Hearing Today for NEET PG 2025 Answer Key Transparency The Supreme Court is set to hear a crucial plea today regarding transparency in the NEET PG 2025 answer key, as aspirants seek fair and verifiable results. A decision in this hearing could pave the way for the long-awaited MCC counselling schedule, which remains on hold.",
      date: "2025-09-23T08:00:00Z",
      priority: "high",
      category: "NEET PG",
    ...
    },
    {
      id: 26,
      title:
        "UP NEET PG 2025: 148 Candidates Barred for Seat Blocking; DGME Releases List",
    ...
    },
    {
      id: 28,
      title:
        "NEET PG 2025 Counselling Start Date Expected Soon; Complete Process Guide Here: ",
    ...
    },
    {
      id: 29,
      title:
        "Supreme Court Gives NBEMS Two Weeks to Respond on NEET PG 2025 Transparency Plea:   ",
    ...
    },
    {
      id: 30,
      title:
        "How to Check NEET PG 2025 Counselling Schedule: Step-by-Step Guide :Medical Counselling Committee has not released NEET PG 2025 counselling schedule yet; candidates can check updates on mcc.nic.in when announced",
    ...
    },
    {
      id: 32,
      title:
        "NEET PG 2025 Counselling Expected to Start in October: Complete Process Guide",
      date: "2025-09-29T08:00:00Z",
      priority: "high",
      category: "NEET PG",
    ...
    },
    {
      id: 33,
      title:
        "Karnataka HC Karnataka HC Dismisses NEET PG 2025 Plea for Category Change After Results Declaration ",
      date: "2025-09-29T08:00:00Z",
      priority: "high",
      category: "NEET PG",
    ...
    },
    {
      id: 34,
      title:
        "NEET PG 2025 Counselling: Expected Mid-October Start Date, Complete Allotment : Medical Counselling Committee expected to release NEET PG 2025 counselling schedule by mid-October 2025 on mcc.nic.in following FAIMA's communication with health ministry. ",
    ...
    },
    {
      id: 35,
      title:
        "MCC Yet to Announce  NEET PG 2025 Counselling Schedule; Medical Aspirants Await Dates : Medical Counselling Committee has not released NEET PG 2025 counselling schedule yet as Supreme Court seeks NBEMS response on transparency issues.",
    ...
    },
    {
      id: 36,
      title:
        "NEET PG 2025 NEET PG 2025 Counselling Expected to Begin Mid-October: Complete Details",
    ...
    },
    {
      id: 37,
      title:
        "Karnataka NEET PG 2025 Round 1 Registration Begins Today at cetonline.karnataka.gov.in :Karnataka Examination Authority begins NEET PG 2025 counselling round 1 registration today October 4 at 11 AM on cetonline.karnataka.gov.in portal.",
    ...
    },
    {
      id: 38,
      title:
        "NEET PG 2025 Counselling Schedule How to Check MCC Updates at mcc.nic.in :Medical Counselling Committee has not released NEET PG 2025 counselling schedule yet; candidates can check mcc.nic.in when dates become available.",
    ...
    },
    {
      id: 47,
      title:
        "NEET PG Counselling 2025: MCC Schedule Expected Soon – Registration Process and Key Dates",
    ...
    },
    {
      id: 49,
      title:
        "NEET PG Counselling 2025: MCC NEET PG Counselling 2025 Round 1 Registration Started at mcc.nic.in: Direct Link, Complete Schedule, Login Process for AIQ Seats",
    ...
    },
    {
      id: 50,
      title:
        "MCC Online NEET PG Seats  Allotment Process 2025: 50% All India Quota Counselling for MD MS and Dental Seats at mcc.nic.in :MCC conducts online counselling for 50% All India Quota NEET PG seats in medical and dental programs at mcc.nic.in following Supreme Court directives for transparent seat allotment",
    ...
    },
    {
      id: 51,
      title:
        "NEET PG Counselling 2025 MCC NEET PG 2025 Counselling Registration Process Ongoing at mcc.nic.in: Complete Round-Wise Schedule to be Released Soon for MD MS Admission",
    ...
    },
    {
      id: 52,
      title:
        "NEET PG Counselling 2025 MCC NEET PG 2025 Round 1 RESET Registration Option Active at mcc.nic.in: Deadline November 5 for Corrections, NRI Documents Due October 28",
    ...
    },
    {
      id: 53,
      title:
        "NEET PG Counselling 2025: NEET PG 2025 Round 1: MCC Activates RESET Registration Until November 5 and Releases NRI Admission Guidelines with October 28 Document Deadline at mcc.nic.in ",
    ...
    },
    {
      id: 54,
      title:
        "NEET PG Counselling 2025: MCC Releases NEET PG 2025 Counselling Schedule at mcc.nic.in: Round 1 Choice Filling Begins October 28, Seat Allotment Result on November 8 for AIQ and State Quota Seats ",
    ...
    },
    {
      id: 56,
      title:
        "NEET PG Counselling 2025: UP NEET PG 2025 Counselling Schedule Released at upneet.gov.in: Round-Wise Dates Announced for Uttar Pradesh State Quota MD/MS/Diploma Admissions ",
    ...
    },
    {
      id: 61,
      title:
        "NEET PG Counselling 2025:PwD Certificate Generation Portal Open for NEET PG 2025 Round 1 - Deadline November 8 at 5 PM",
    ...
    },
    {
      id: 71,
      title:
        "NEET PG Counselling 2025 The choice filling has been extended by 2-3 days in larger interest of candidates.",
    ...
    },
    {
      id: 71,
      title:
        "NEET PG Counselling 2025 Revised: 239 New Deemed University Seats Added, 235 DNB Seats Withdrawn – Choice Filling Extended Till November 21",
      date: "2025-11-19T08:00:00Z",
      priority: "high",
      category: "NEET PG",
    ...
    },
    {
      id: 90,
      title:
        "NEET PG 2025 Counselling: MCC Extends Round 2 Reporting & Resignation Deadline Till December 29, 4 PM at mcc.nic.in",
