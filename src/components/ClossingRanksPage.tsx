  ...
  const parseCSV = (csvText: string): RanksData[] => {
    ...
    return dataLines.slice(1).map((line) => {
      ...
      return {
        ...
        "2024 R1": parseNumber(cleanedValues[6]),
        "2024 R2": parseNumber(cleanedValues[7]),
        "2024 R3": parseNumber(cleanedValues[8]),
        "2024 R4": parseNumber(cleanedValues[9]),
        "2024 R5": parseNumber(cleanedValues[10]),
        "2023 R1": parseNumber(cleanedValues[11]),
        "2023 R2": parseNumber(cleanedValues[12]),
        "2023 R3": parseNumber(cleanedValues[13]),
        "2023 R4": parseNumber(cleanedValues[14]),
        "2022 R1": parseNumber(cleanedValues[15]),
        "2022 R2": parseNumber(cleanedValues[16]),
        "2022 R3": parseNumber(cleanedValues[17]),
        "2022 R4": parseNumber(cleanedValues[18]),
      };
    });
  };
