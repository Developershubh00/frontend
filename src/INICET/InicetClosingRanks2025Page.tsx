...
interface InicetClosingRanks2025PageProps {
  onBack: () => void;
}
...
// ── Main component ─────────────────────────────────────────────────────────
const InicetClosingRanks2025Page: React.FC<InicetClosingRanks2025PageProps> = ({
  onBack,
}) => {
  ...
  useEffect(() => {
    fetch("/data/inicetData/inicet_closing_ranks_2025.csv")
      .then((r) => {
      ...
      <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-purple-100">JAN & JUL 2025 Sessions</p>
              </div>
            </div>
        ...
        {dataError && (
          <div className="bg-amber-50 border-b border-amber-200 px-4 py-2 text-xs text-amber-700 text-center">
            ...
            <code>/data/inicetData/inicet_closing_ranks_2025.csv</code> to enable this page.
          </div>
        )}
