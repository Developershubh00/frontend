...
// const InicetClosingRanksPage: React.FC = () => {
//   const { user } = useAuth();
//   const navigate = useNavigate();
//   const [activeSection, setActiveSection] = useState("closing-ranks");
...
//                 </div>
//                 <div>
//                   <h1 className="text-2xl lg:text-3xl font-bold text-slate-800">INICET Closing Ranks</h1>
//                   <p className="text-slate-600">Category-wise cutoff ranks for INICET</p>
//                 </div>
//               </div>
//               <div className="bg-blue-50 rounded-xl p-6 text-center">
//                 <p className="text-slate-700">Closing ranks data will be displayed here. Connect to your data source to populate this page.</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
// export default InicetClosingRanksPage;
...
interface InicetAllotmentsSessionPageProps {
  onBack: () => void;
}
...
const InicetAllotmentsSessionPage: React.FC<InicetAllotmentsSessionPageProps> = ({
  onBack,
}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Error fetching INICET session data:", error);
    ...
    return (
      <div className="flex-1 bg-gradient-to-br from-rose-50 via-blue-50 to-indigo-50 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600">Loading INICET Session Data...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-semibold">INICET Jul Session</h1>
...
export default InicetAllotmentsSessionPage;
