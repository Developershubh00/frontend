...
interface July2026AllotmentPageProps {
  onBack: () => void;
}
...
const July2026AllotmentPage: React.FC<July2026AllotmentPageProps> = ({
  onBack,
}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("/data/inicetData/inicet_july_2026_session.csv");
...
export default July2026AllotmentPage;
