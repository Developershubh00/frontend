...
interface Jan2026AllotmentPageProps {
  onBack: () => void;
}
...
const Jan2026AllotmentPage: React.FC<Jan2026AllotmentPageProps> = ({
  onBack,
}) => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "/data/inicetData/inicet_jan_2026_session.csv",
        );
...
export default Jan2026AllotmentPage;
